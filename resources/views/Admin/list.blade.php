                ...
                <ul class="flex flex-wrap gap-4 p-4">
                    <li class="relative bg-gg text-white rounded-lg overflow-hidden w-full md:w-1/2 lg:w-1/3">
                        ...
                        <div class="relative overflow-hidden rounded-t-lg">
                            <img class="w-full h-64 object-cover transition-transform duration-500 ease-in-out transform hover:scale-110" src="{{ asset('images/background-admin.jpg') }}" alt="Car Image">
                        </div>
                        <!-- Information Section -->
                        <div class="p-10 bg-gg text-white">
                            ...
                            <div class="mb-2 p-1">
                                ...
                                <div class="flex items-center justify-between mb-3 text-gray-400">
                                    ...
                                    <p class="ml-2 text-white">Auto</p>
                                </div>
                                <div class="flex items-center mb-3 text-gray-400 justify-between">
                                    <div class="flex items-center">
                                ...
                                <div class="flex items-center mb-3 text-gray-400 justify-between">
                                    ...
                                    <p class="ml-2 text-white">gold</p>
                                </div>
                                <div class="flex items-center mb-3 text-gray-400 justify-between">
                                    <div class="flex items-center">
                                    ...
                                    <p class="ml-2 text-white">127003km</p>
                                </div>
                                <div class="flex items-center mb-3 text-gray-400 justify-between">
                                    <div class="flex items-center">
                                    ...
                                    <p class="ml-2 text-white">disel</p>
                                </div>
                                <div class="flex items-center mb-3 text-gray-400 justify-between">
                                    <div class="flex items-center">
                                    ...
                                    <p class="ml-2 text-white">2022</p>
                                </div>
                            </div>
                            <div class="flex justify-between items-center mt-4">
                                <div class="text-lg">
                                    <span class="text-gold font-bold">$500</span> / day
                                </div>
